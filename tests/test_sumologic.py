...
def test_sumologic_function_success(requests_mock):
    ...
    """
    requests_mock.get('/api/v1/collectors', [{'status_code': 401}, {'status_code': 301, 'headers': {'Location': 'https://api.au.sumologic.com/api/v1/collectors'}}])
    requests_mock.get('https://api.au.sumologic.com/api/v1/collectors', status_code=200)
    s, sumoEnd = common._sumologic_session(accessId='1234', accessKey='4567')
